      ...
      *----
       ...
       01  WS-WORK-AREA.
           ...
           05 WS-PRO-TYPE          PIC 9(01).
              88 WS-PRO-T-S              VALUE 1 2 THRU 3 5.
           05 WS-SUB-AREA.
      ...
      *-----
      ...
      -       (CHECK-FILE-OUTPUT NOT = 0)
       ...
       H300-MOVE.
           COMPUTE WS-PRO-TYPE = FUNCTION NUMVAL(INP-ISLEM-TIPI)


           IF WS-PRO-T-S
                 EVALUATE WS-PRO-TYPE
                     WHEN 1
      ...
      *----
       ...
       UPDATE-RECORD.
           ...
           INVALID KEY MOVE 'KAYIT BULUNAMADI' TO OUT-ACIKLAMA
           NOT INVALID KEY MOVE 'KAYIT BULUNDU' TO OUT-ACIKLAMA.
           MOVE WS-PRO-TYPE TO OUT-ISLEM-TIPI
